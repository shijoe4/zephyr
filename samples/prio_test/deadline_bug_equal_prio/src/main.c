...
LOG_DBG("Main: start\n");
  ...
  thread2_pointer=  k_thread_create(&thread_m_data, stack_m, STACK_SIZE, thread_med_entry, 
   ...
   k_thread_absolute_deadline_set(&thread_l_data, 1500000);
   k_thread_absolute_deadline_set(&thread_m_data, 1500000);
   k_thread_absolute_deadline_set(&thread_h_data, 1500000);
