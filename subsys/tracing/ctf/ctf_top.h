...
typedef enum {
	...
	CTF_EVENT_MUTEX_CEILING_FLOOR_INIT = 0x186,
	CTF_EVENT_MUTEX_CEILING_FLOOR_LOCK_ENTER = 0x187,
	CTF_EVENT_MUTEX_CEILING_FLOOR_LOCK_BLOCKING = 0x188,
	CTF_EVENT_MUTEX_CEILING_FLOOR_LOCK_EXIT = 0x189,
	CTF_EVENT_MUTEX_CEILING_FLOOR_UNLOCK_ENTER = 0x18A,
	CTF_EVENT_MUTEX_CEILING_FLOOR_UNLOCK_EXIT = 0x18B,

	
	CTF_EVENT_THREAD_DEADLINE_SET = 0x18C,
	CTF_EVENT_THREAD_ABSOLUTE_DEADLINE_SET = 0x18D,
	CTF_EVENT_THREAD_SCHED_DEADLINE_SET = 0x18E,
	CTF_EVENT_THREAD_SCHED_ABSOLUTE_DEADLINE_SET = 0x18F,
